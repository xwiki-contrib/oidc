 ...
 */
package org.xwiki.contrib.oidc.consent.internal.ui;
...
public class UserApplicationsUIExtension implements UIExtension, Initializable
{
     ...
     */
    public static final String ID = "oidc.consent.userapplications";
    ...
    {
        return this.templates.executeNoException("oidc/consent/userapplications.vm");
    }
}
