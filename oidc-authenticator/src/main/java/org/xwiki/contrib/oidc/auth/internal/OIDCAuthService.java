...
/**
 * Expose the OpenID Connect authenticator as component.
 * 
 * @version $Id$
 * @since 1.35.0
 */
@Component
@Singleton
@Named(OIDCAuthService.ID)
public class OIDCAuthService extends AbstractXWikiAuthServiceWrapper implements XWikiAuthServiceComponent
{
    /**
    ...
    /**
     * Wrap a {@link OIDCAuthServiceImpl} instance.
     */
    public OIDCAuthService()
    {
        super(new OIDCAuthServiceImpl());
    }
